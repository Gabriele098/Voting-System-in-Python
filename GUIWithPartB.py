...
class MainWindow:
    ...
    def result_day(self):
        ...
        if start_date <= open_date <= end_date:
            ...
            showinfo("Alert Message", "Sorry, voting is now closed.")
...
class SecondWindow:
    ...
    def __init__(self, master):
        ...
        self.login_entry = tk.Button(text="Login", font=("Gill Sans MT", "12", "bold"), height=1, width="18",
                                     command=self.check_user)
        self.login_entry.place(relx=0.60, rely=0.48, anchor="e")

        self.login_entry = tk.Button(text="Go back", font=("Gill Sans MT", "12", "bold"), height=1, width="18",
            ...
            if student.username == self.username_attempt and student.password == self.password_attempt:
                ...
                if student.has_registered:
                    ...
                    for row in c:
                        if student.username in row:
                            cuv += 1
                    # Checks that the user has not voted for any position. If true they can login
                    if cuv == 0:
                        self.new_window()
                    else:
...
class ThirdWindow:
    def __init__(self, master):
        ...
        self.main_label2.place(relx=0.50, rely=0.40, anchor="center")

        self.choose_label = tk.Label(text="Select one of the following positions", bg="white",
...
class SignOutWindow:
    ...
    def __init__(self, master):
        ...
        self.quit_button = tk.Button(text="Quit", font=("Gill Sans MT", "12", "bold"), height="2",
    ...
    def save_choice(self):
        ...
        if (self.first_box.get() in president_names and self.second_box.get() in president_names and
            ...
            if (self.first_box.get() != self.second_box.get() and self.first_box.get() != self.third_box.get() and
                ...
                first_comment = str(input(f"Please tell us why {self.first_choice} is your first preference:  "))
                second_comment = str(input(f"Please tell us why {self.second_choice} is your second preference:  "))
                third_comment = str(input(f"Please tell us why {self.third_choice} is your third preference:  "))
                fourth_comment = str(input(f"Please tell us why {self.fourth_choice} is your fourth preference:  "))
                globals()["first_comment"] = first_comment
                globals()["second_comment"] = second_comment
                globals()["third_comment"] = third_comment
                globals()["fourth_comment"] = fourth_comment

                # HACKATHON COMMENT TASK CREATED BY YORK RIDER

                # if (self.first_choice == "Indi Franklin" or self.first_choice == "Ryan Hays" or self.first_choice
                #         == "Esther Barracks" or self.first_choice == "Andrei Keely"):
                #     user_comment = str(input(f"Please tell us why {self.first_choice} is your first preference:  "))
                #     globals()["president_comments"] = user_comment
...
class FacultyWindowEH:
    ...
    def __init__(self, master):
        ...
        self.unique_label.place(relx=0.5, rely=0.63, anchor="center")
...
class FacultyWindowES:
    ...
    def __init__(self, master):
        ...
        self.unique_label.place(relx=0.50, rely=0.63, anchor="center")
...
class ResultsWindow:
    def __init__(self, master):
        ...
        self.first_label = tk.Label(text="GSU ELECTIONS : Results", width="50", fg="#FFC0CB", bg="#252850",
                                    font=("Century Gothic", "55", "bold"))
        self.first_label.place(relx=0.5, rely=0.20, anchor='center')
        self.choose = tk.Label(text="Select a position to view the current voting results", width="60",
                               fg="white", bg="#252850",
...
class ResultsPresidentW:
    def __init__(self, master):
        ...
        self.first_label = tk.Label(text="GSU ELECTIONS : Results", width="50", fg="#FFC0CB", bg="#252850",
                                    font=("Century Gothic", "55", "bold"))
        self.first_label.place(relx=0.5, rely=0.15, anchor='center')
        self.second_label = tk.Label(text="President", width="30", fg="white", bg="#252850",
                                     font=("Century Gothic", "40", "bold", "italic", "underline"))
        self.second_label.place(relx=0.5, rely=0.30, anchor='center')
        self.candidate_list = Listbox(master, width=32, height=6, bg="white", fg="#252850",
                                      font=("Century Gothic", "20"))
        self.candidate_list.place(relx=0.30, rely=0.54, anchor='center')
        # self.candidate_list.insert(END, "    Candidate  :    1stP    -    2ndP    -    3rdP    -    4thP")
        self.candidate_list.insert(END, "\n  ")
        ...
        self.winner_name = tk.Label(text="Winner: %s" % newList[0], width="18", fg="#252850", bg="#FFC0CB",
                                    font=("Century Gothic", "20", "bold"))
        self.winner_name.place(relx=0.80, rely=0.55, anchor='center')
        total_votes = 0
        winning_votes = 0
        ...
        for row in c:
            ...
            if newList[0] in row:
                winning_votes += 1
        if total_votes != 0:
            percentage = (winning_votes * 100) / total_votes
        else:
            percentage = 0
        self.total_votes = tk.Label(text="Total votes overall: %d" % total_votes,
                                    width="18", fg="white", bg="#252850",
                                    font=("Century Gothic", "19"))
        self.total_votes.place(relx=0.5, rely=0.75, anchor='center')
        self.votes_winner = tk.Label(text="Votes the winner received: %d" % winning_votes,
                                     width="25", fg="white", bg="#252850",
                                     font=("Century Gothic", "19"))
        self.votes_winner.place(relx=0.5, rely=0.80, anchor='center')
        self.percentage = tk.Label(text="Percentage of votes received by the winner: %d" % percentage,
                                   width="45", fg="white", bg="#252850",
                                   font=("Century Gothic", "19"))
...
class ResultsGSUW:
    def __init__(self, master):
        ...
        self.first_label = tk.Label(text="GSU ELECTIONS : Results", width="50", fg="#FFC0CB", bg="#252850",
                                    font=("Century Gothic", "55", "bold"))
        self.first_label.place(relx=0.5, rely=0.15, anchor='center')
        self.second_label = tk.Label(text="GSU Officers", width="30", fg="white", bg="#252850",
                                     font=("Century Gothic", "40", "bold", "italic", "underline"))
        self.second_label.place(relx=0.5, rely=0.27, anchor='center')
        self.candidate_list = Listbox(master, width=35, height=14, bg="white", fg="#252850",
        ...
        self.winner_name = tk.Label(text="Winners: %s" % newList1[0] + "\n %s" % newList1[1] + "\n %s" % newList1[2],
                                    fg="#252850", bg="#FFC0CB", width="18",
                                    font=("Century Gothic", "20", "bold"))
        self.winner_name.place(relx=0.80, rely=0.59, anchor='center')
        total_votes = 0
        winning_votes = 0
        ...
        self.total_votes = tk.Label(text="Total votes overall: %d" % total_votes, width="18",
                                    fg="white", bg="#252850",
                                    font=("Century Gothic", "18"))
        self.total_votes.place(relx=0.50, rely=0.80, anchor='center')
        self.votes_winner = tk.Label(text="Votes the winner received: %d" % winning_votes,
                                     width="25", fg="white", bg="#252850",
                                     font=("Century Gothic", "18"))
        self.votes_winner.place(relx=0.50, rely=0.85, anchor='center')
        # percentage formula works out the percentage of votes the winner won by.
        self.percentage = tk.Label(text="Percentage of votes received by the winners: %d" % percentage,
                                   width="45", fg="white",
                                   bg="#252850",
                                   font=("Century Gothic", "18"))
...
class ResultsASFacultyWindow:
    def __init__(self, master):
        ...
        self.first_label = tk.Label(text="GSU ELECTIONS : Results", width="50", fg="#FFC0CB", bg="#252850",
                                    font=("Century Gothic", "55", "bold"))
        self.first_label.place(relx=0.5, rely=0.05, anchor='center')
        self.second_label = tk.Label(text="Faculty Officers - Liberal Arts and Sciences", width="60", fg="white",
                                     bg="#252850", font=("Century Gothic", "30", "bold", "italic", "underline"))
        self.second_label.place(relx=0.5, rely=0.15, anchor='center')
        self.candidate_list = Listbox(master, width=35, height=18, bg="white", fg="#252850",
                                      font=("Century Gothic", "15"))
        self.candidate_list.place(relx=0.30, rely=0.48, anchor='center')
        # self.candidate_list.insert(END, "    Candidate  :    1stP    -    2ndP    -    3rdP    -    4thP")
        self.candidate_list.insert(END, "\n  ")
        ...
        # Depends on the votes
        self.winner_name = tk.Label(text="Winners: %s" % newList5[0] + "\n %s" %
                                         newList5[1] + "\n %s" % newList5[2] +
                                         "\n %s" % newList5[3], fg="#252850", bg="#FFC0CB",
                                    width="20", font=("Century Gothic", "20", "bold"))
        self.winner_name.place(relx=0.77, rely=0.51, anchor='center')
        total_votes = 0
        winning_votes = 0
        # check the amount of 1st preference votes the winner received
        c.execute("SELECT FirstPreference FROM FacultyOfficerVotes WHERE Faculty = 'AS'")
        for row in c:
            total_votes += 1
        ...
        if total_votes != 0:
            ...
            percentage = 0
        self.total_votes = tk.Label(text="Total votes overall: %d" % total_votes, width="18", fg="white", bg="#252850",
                                    font=("Century Gothic", "18"))
        self.total_votes.place(relx=0.5, rely=0.80, anchor='center')
        self.votes_winner = tk.Label(text="Votes the winners received: %d" % winning_votes,
                                     width="25", fg="white", bg="#252850",
                                     font=("Century Gothic", "18"))
        self.votes_winner.place(relx=0.5, rely=0.85, anchor='center')
        self.percentage = tk.Label(text="Percentage of votes received by the winners: %d" % percentage,
                                   width="45", fg="white", bg="#252850",
                                   font=("Century Gothic", "18"))
...
class ResultsEHFacultyWindow:
    def __init__(self, master):
        ...
        self.first_label = tk.Label(text="GSU ELECTIONS : Results", width="50", fg="#FFC0CB", bg="#252850",
                                    font=("Century Gothic", "55", "bold"))
        self.first_label.place(relx=0.5, rely=0.05, anchor='center')
        self.second_label = tk.Label(text="Faculty of Education Officers", width="60", fg="white", bg="#252850",
        ...
        self.winner.place(relx=0.77, rely=0.40, anchor='center')
        # Depends on the votes
        self.winner_name = tk.Label(text="Winners: %s" % newList4[0] + "\n %s" % newList4[1] + "\n %s" % newList4[2] +
                                         "\n %s" % newList4[3], fg="#252850", bg="#FFC0CB",
                                    width="30", font=("Century Gothic", "15", "bold"))
        self.winner_name.place(relx=0.77, rely=0.48, anchor='center')
        total_votes = 0
        winning_votes = 0
...
class ResultsESFacultyWindow:
    def __init__(self, master):
        ...
        self.first_label = tk.Label(text="GSU ELECTIONS : Results", width="50", fg="#FFC0CB", bg="#252850",
                                    font=("Century Gothic", "55", "bold"))
        self.first_label.place(relx=0.5, rely=0.05, anchor='center')
        self.second_label = tk.Label(text="Faculty of Engineering and Science Officers", width="60", fg="white",
                                     bg="#252850", font=("Century Gothic", "30", "bold", "italic", "underline"))
        self.second_label.place(relx=0.5, rely=0.15, anchor='center')
        self.candidate_list = Listbox(master, width=35, height=18, bg="white", fg="#252850",
                                      font=("Century Gothic", "15"))
        ...
        self.winner.place(relx=0.77, rely=0.40, anchor='center')
        # Depends on the votes
        self.winner_name = tk.Label(text="Winners: %s" % newList3[0] + "\n %s" % newList3[1] + "\n %s" % newList3[2] +
...
class ResultsSBFacultyWindow:
    def __init__(self, master):
        ...
        self.first_label = tk.Label(text="GSU ELECTIONS : Results", width="50", fg="#FFC0CB", bg="#252850",
                                    font=("Century Gothic", "55", "bold"))
        self.first_label.place(relx=0.5, rely=0.05, anchor='center')
        self.second_label = tk.Label(text="School of Business Officers", width="60", fg="white", bg="#252850",
                                     font=("Century Gothic", "30", "bold", "italic", "underline"))
        self.second_label.place(relx=0.5, rely=0.15, anchor='center')
        self.candidate_list = Listbox(master, width=35, height=18, bg="white", fg="#252850",
                                      font=("Century Gothic", "15"))
        ...
        self.winner.place(relx=0.77, rely=0.40, anchor='center')
        # Depends on the votes
        self.winner_name = tk.Label(text="Winners: %s" % newList2[0] + "\n %s" % newList2[1] + "\n %s" % newList2[2] +
...
class ResultsSummaryWindow:
    def __init__(self, master):
        ...
        self.first_label = tk.Label(text="GSU ELECTIONS : Results", width="50", fg="#FFC0CB", bg="#252850",
                                    font=("Century Gothic", "55", "bold"))
        self.first_label.place(relx=0.5, rely=0.05, anchor='center')
        self.second_label = tk.Label(text="Summary", width="60", fg="white", bg="#252850",
                                     font=("Century Gothic", "30", "bold", "italic", "underline"))
        self.second_label.place(relx=0.5, rely=0.15, anchor='center')
        self.president_lbl = tk.Label(text="President", fg="#252850", bg="white", width=22,
                                      font=("Century Gothic", "23", "bold", "italic"))
        self.president_lbl.place(relx=0.25, rely=0.24, anchor='center')
        self.president_winner = tk.Label(text=" %s" % newList[0], fg="#252850", bg="#FFC0CB", width=27,
                                         font=("Century Gothic", "18"))
        self.president_winner.place(relx=0.75, rely=0.24, anchor='center')
        self.gsu_lbl = tk.Label(text="GSU Officers", fg="#252850", bg="white", width=22,
                                font=("Century Gothic", "23", "bold", "italic"))
        self.gsu_lbl.place(relx=0.25, rely=0.33, anchor='center')
        self.gsu_winner = tk.Label(text=" %s," % newList1[0] + " %s," % newList1[1] + "\n %s" % newList1[2],
                                   fg="#252850", bg="#FFC0CB", width=27, font=("Century Gothic", "18"))
        self.gsu_winner.place(relx=0.75, rely=0.33, anchor='center')
        self.sb_lbl = tk.Label(text="School of Business", fg="#252850", bg="white", width=22,
                               font=("Century Gothic", "23", "bold", "italic"))
        self.sb_lbl.place(relx=0.25, rely=0.44, anchor='center')
        self.sb_winner = tk.Label(text=" %s," % newList2[0] + " %s," % newList2[1] + "\n %s," % newList2[2] +
                                       " %s" % newList2[3], fg="#252850", bg="#FFC0CB", width=27,
                                  font=("Century Gothic", "18"))
        self.sb_winner.place(relx=0.75, rely=0.44, anchor='center')
        self.as_lbl = tk.Label(text="Faculty of Liberal Arts \n and Sciences", fg="#252850", bg="white", width=22,
                               font=("Century Gothic", "23", "bold", "italic"))
        self.as_lbl.place(relx=0.25, rely=0.57, anchor='center')
        self.as_winner = tk.Label(text=" %s," % newList5[0] + " %s," % newList5[1] + "\n %s," % newList5[2] +
                                       " %s" % newList5[3], fg="#252850", bg="#FFC0CB", width=27,
                                  font=("Century Gothic", "18"))
        self.as_winner.place(relx=0.75, rely=0.57, anchor='center')
        self.eh_lbl = tk.Label(text="Faculty of Education", fg="#252850", bg="white", width=22,
                               font=("Century Gothic", "23", "bold", "italic"))
        self.eh_lbl.place(relx=0.25, rely=0.69, anchor='center')
        self.eh_winner = tk.Label(text=" %s," % newList4[0] + " %s," % newList4[1] + "\n %s," % newList4[2] +
                                       " %s" % newList4[3], fg="#252850", bg="#FFC0CB", width=27,
                                  font=("Century Gothic", "18"))
        self.eh_winner.place(relx=0.75, rely=0.69, anchor='center')
        self.es_lbl = tk.Label(text="Faculty of Engineering \n and Science", fg="#252850", bg="white", width=22,
                               font=("Century Gothic", "23", "bold", "italic"))
        self.es_lbl.place(relx=0.25, rely=0.82, anchor='center')
        self.es_winner = tk.Label(text=" %s," % newList3[0] + " %s," % newList3[1] + "\n %s," % newList3[2] +
                                       " %s" % newList3[3], fg="#252850", bg="#FFC0CB", width=27,
                                  font=("Century Gothic", "18"))
        self.es_winner.place(relx=0.75, rely=0.82, anchor='center')
        self.back = tk.Button(text='Back', font=("Gill Sans MT", "12", "bold"), height="1", width="20",
                              command=self.go_back)
...
if __name__ == '__main__':
    ...
    global second_comment
    global third_comment
    global fourth_comment

    with open("President_Comments", "w") as write_pres:
        write_pres.write(first_comment+"\n"+second_comment+"\n"+third_comment+"\n"+fourth_comment)
